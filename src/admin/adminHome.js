...
import ViewSlot from '../staff/viewSlots';
...
function AdminHome() {
    ...
    const [activeComponent, setActiveComponent] = useState("viewSlots");
    ...
    //to toggle the dropdown on click of profile
    ...
    return (
        <div className="min-h-screen bg-gray-50 text-slate-900 font-sans">
                ...
                <div className="container mx-auto px-2 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-6">
                            <button
                                onClick={() => setActiveComponent("viewSlots")}
                            ...
                            <button
                                onClick={() => setActiveComponent("logDetails")}
                                className="px-4 py-2 text-slate-700 hover:text-blue-900 hover:bg-slate-100 rounded-lg transition-colors duration-200 text-l font-medium"
                            >
                                Log Details
                            </button>
                            <button
                                onClick={() => setActiveComponent("vehicleLogs")}
                                className="px-4 py-2 text-slate-700 hover:text-blue-900 hover:bg-slate-100 rounded-lg transition-colors duration-200 text-l font-medium"
                            >
                                Vehicle Logs
                            </button>
            ...
            {activeComponent === 'addStaff' && <AddStaff username={username} role={role} />}
            {activeComponent === 'viewSlots' && <ViewSlot username={username} role={role} />}
            {activeComponent === 'logDetails' && <LogRecords role={role} />}
            {activeComponent === 'vehicleLogs' && <VehicleRecords role={role} />}
